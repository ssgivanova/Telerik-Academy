 ...
 */
class OneSystemToAnyOtherBigInteger
{
    /*
    static void Main()
    {
    ...
    static string ConvertFromBaseSToBaseD(int s, int d, string number)
    {
        ...
        BigInteger decimalNum = ConvertFromBaseSToDecimal(s, number);

        string result = ConvertFromDecimalToBaseD(d, decimalNum);
        return result;
    }

    static BigInteger ConvertFromBaseSToDecimal(int s, string number)
    {
    ...
    static string ConvertFromDecimalToBaseD(int d, BigInteger decimalNum)
    {
        string converted = "";
        while (decimalNum > 0)
        {
            BigInteger remainder = decimalNum % d;
